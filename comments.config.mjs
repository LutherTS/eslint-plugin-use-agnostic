...
export const resolvedConfigData = {
  "jsDoc": {
    "definitions": {
      "makeTestFiles": {
        "value": "Makes the paths of the files to be linted for agnostic20 and directive21." /* $COMMENT#JSDOC#DEFINITIONS#MAKETESTFILES */,
        "key": "JSDOC#DEFINITIONS#MAKETESTFILES",
        "placeholder": "$COMMENT#JSDOC#DEFINITIONS#MAKETESTFILES"
      },
      "highlightFirstLineOfCode": {
        "value": "Gets the coordinates for the first line of code of a file." /* $COMMENT#JSDOC#DEFINITIONS#HIGHLIGHTFIRSTLINEOFCODE */,
      ...
      "makeIntroForSpecificViolationMessage": {
        "value": "Makes the intro for each specific import rule violation messages." /* $COMMENT#JSDOC#DEFINITIONS#MAKEINTROFORSPECIFICVIOLATIONMESSAGE */,
      ...
      "agnostic20": {
        ...
        "makeBlockedImport": {
          "value": "Makes a blockedImport object for the identified blocked import at hand." /* $COMMENT#JSDOC#DEFINITIONS#AGNOSTIC20#MAKEBLOCKEDIMPORT */,
          "key": "JSDOC#DEFINITIONS#AGNOSTIC20#MAKEBLOCKEDIMPORT" /* $COMMENT#JSDOC#DEFINITIONS#AGNOSTIC20#MAKEBLOCKEDIMPORT */,
          "placeholder": "$COMMENT#JSDOC#DEFINITIONS#AGNOSTIC20#MAKEBLOCKEDIMPORT"
        },
        "makeBlockedImportSuggestingUseAgnostic": {
          "value": "Makes a blockedImport object for the identified blocked import at hand enhanced with the suggestion to use the `'use agnostic'` directive." /* $COMMENT#JSDOC#DEFINITIONS#AGNOSTIC20#MAKEBLOCKEDIMPORTSUGGESTINGUSEAGNOSTIC */,
        ...
        "getEffectiveDirective": {
          "value": "Gets the effective directive of a module, based on the combination of its directive (or lack thereof) and its extension (depending on whether it ends with 'x' for JSX)." /* $COMMENT#JSDOC#DEFINITIONS#AGNOSTIC20#GETEFFECTIVEDIRECTIVE */,
        ...
        "importsFlow": {
          "value": "The full flow for import traversals to enforce effective directives import rules." /* $COMMENT#JSDOC#FORALIASVARIABLES#IMPORTSFLOW */,
          "key": "JSDOC#DEFINITIONS#AGNOSTIC20#IMPORTSFLOW",
          "placeholder": "$COMMENT#JSDOC#DEFINITIONS#AGNOSTIC20#IMPORTSFLOW"
        },
        "reExportsFlow": {
          "value": "The full flow for export traversals, shared between `ExportNamedDeclaration` and `ExportAllDeclaration`, to ensure same effective directive re-exports." /* $COMMENT#JSDOC#DEFINITIONS#AGNOSTIC20#REEXPORTSFLOW */,
      ...
      "directive21": {
        ...
        "detectQuoteType": {
          "value": "Detects whether a string is single- or double-quoted." /* $COMMENT#JSDOC#DEFINITIONS#DIRECTIVE21#DETECTQUOTETYPE */,
          "key": "JSDOC#DEFINITIONS#DIRECTIVE21#DETECTQUOTETYPE",
          "placeholder": "$COMMENT#JSDOC#DEFINITIONS#DIRECTIVE21#DETECTQUOTETYPE"
        },
        "stripSingleQuotes": {
          "value": "Removes single quotes from a string known to be single-quoted." /* $COMMENT#JSDOC#DEFINITIONS#DIRECTIVE21#STRIPSINGLEQUOTES */,
          "key": "JSDOC#DEFINITIONS#DIRECTIVE21#STRIPSINGLEQUOTES",
          "placeholder": "$COMMENT#JSDOC#DEFINITIONS#DIRECTIVE21#STRIPSINGLEQUOTES"
        },
        "stripDoubleQuotes": {
          "value": "Removes double quotes from a string known to be double-quoted." /* $COMMENT#JSDOC#DEFINITIONS#DIRECTIVE21#STRIPDOUBLEQUOTES */,
        ...
        "getCommentedDirectiveFromSourceCode1": {
          "value": "Gets the commented directive of a module from its ESLint `SourceCode` object." /* $COMMENT#JSDOC#DEFINITIONS#DIRECTIVE21#GETCOMMENTEDDIRECTIVEFROMSOURCECODE1 */,
          "key": "JSDOC#DEFINITIONS#DIRECTIVE21#GETCOMMENTEDDIRECTIVEFROMSOURCECODE1",
          "placeholder": "$COMMENT#JSDOC#DEFINITIONS#DIRECTIVE21#GETCOMMENTEDDIRECTIVEFROMSOURCECODE1"
        },
        "getCommentedDirectiveFromSourceCode2": {
          "value": "Accepted directives for the default Directive-First Architecture are (single or double quotes included):" /* $COMMENT#JSDOC#DEFINITIONS#DIRECTIVE21#GETCOMMENTEDDIRECTIVEFROMSOURCECODE2 */,
          "key": "JSDOC#DEFINITIONS#DIRECTIVE21#GETCOMMENTEDDIRECTIVEFROMSOURCECODE2" /* $COMMENT#JSDOC#DEFINITIONS#DIRECTIVE21#GETCOMMENTEDDIRECTIVEFROMSOURCECODE2 */,
          "placeholder": "$COMMENT#JSDOC#DEFINITIONS#DIRECTIVE21#GETCOMMENTEDDIRECTIVEFROMSOURCECODE2"
        },
        "getCommentedDirectiveFromCurrentModule1": {
        ...
        "getVerifiedCommentedDirective": {
          "value": "Ensures that a module's commented directive is consistent with its file extension (depending on whether it ends with 'x' for JSX)." /* $COMMENT#JSDOC#DEFINITIONS#DIRECTIVE21#GETVERIFIEDCOMMENTEDDIRECTIVE */,
        ...
        "getStrategizedDirective": {
          "value": "Gets the interpreted directive from a specified commented Strategy (such as `@serverLogics`) nested inside the import (or export) declaration for an import (or export) from an Agnostic Strategies Module." /* $COMMENT#JSDOC#DEFINITIONS#DIRECTIVE21#GETSTRATEGIZEDDIRECTIVE */,
          "key": "JSDOC#DEFINITIONS#DIRECTIVE21#GETSTRATEGIZEDDIRECTIVE",
          "placeholder": "$COMMENT#JSDOC#DEFINITIONS#DIRECTIVE21#GETSTRATEGIZEDDIRECTIVE"
        },
        "addressDirectiveIfAgnosticStrategies": {
          "value": "Verifies the current node's export strategy if the current commented directive is `\"use agnostic strategies\"` by reporting `exportNotStrategized` in case an export is not strategized in an Agnostic Strategies Module." /* $COMMENT#JSDOC#DEFINITIONS#DIRECTIVE21#ADDRESSDIRECTIVEIFAGNOSTICSTRATEGIES */,
    ...
    "params": {
      "validPath": {
        "value": "The directory for the valid paths." /* $COMMENT#JSDOC#PARAMS#VALIDPATH */,
        "key": "JSDOC#PARAMS#VALIDPATH",
        "placeholder": "$COMMENT#JSDOC#PARAMS#VALIDPATH"
      },
      "invalidPath": {
        "value": "The directory for the invalid paths." /* $COMMENT#JSDOC#PARAMS#INVALIDPATH */,
        "key": "JSDOC#PARAMS#INVALIDPATH",
        "placeholder": "$COMMENT#JSDOC#PARAMS#INVALIDPATH"
      },
      "contextA": {
        "value": "An ESLint rule's `context` object." /* $COMMENT#JSDOC#PARAMS#CONTEXTA */,
        "key": "JSDOC#PARAMS#CONTEXTA",
        "placeholder": "$COMMENT#JSDOC#PARAMS#CONTEXTA"
      },
      "contextB": {
        "value": "The ESLint rule's `context` object." /* $COMMENT#JSDOC#PARAMS#CONTEXTB */,
        "key": "JSDOC#PARAMS#CONTEXTB",
        "placeholder": "$COMMENT#JSDOC#PARAMS#CONTEXTB"
      },
      "resolvedDirectives_blockedImports": {
        "value": "The blocked imports object, either for agnostic20 or for directive21." /* $COMMENT#JSDOC#PARAMS#RESOLVEDDIRECTIVES_BLOCKEDIMPORTS */,
      ...
      "currentFileResolvedDirectiveB": {
        "value": "The \"resolved\" directive of the \"resolved\" module." /* $COMMENT#JSDOC#PARAMS#CURRENTFILERESOLVEDDIRECTIVEB */,
        "key": "JSDOC#PARAMS#CURRENTFILERESOLVEDDIRECTIVEB",
        "placeholder": "$COMMENT#JSDOC#PARAMS#CURRENTFILERESOLVEDDIRECTIVEB"
      },
      "plugin": {
        "value": "The use-agnostic ESLint plugin itself." /* $COMMENT#JSDOC#PARAMS#PLUGIN */,
        "key": "JSDOC#PARAMS#PLUGIN",
        "placeholder": "$COMMENT#JSDOC#PARAMS#PLUGIN"
      },
      "resolvedPath": {
        "value": "The resolved path of the imported module." /* $COMMENT#JSDOC#PARAMS#RESOLVEDPATH */,
        "key": "JSDOC#PARAMS#RESOLVEDPATH",
        "placeholder": "$COMMENT#JSDOC#PARAMS#RESOLVEDPATH"
      },
      "extension": {
        "value": "The JavaScript (TypeScript) extension of the file." /* $COMMENT#JSDOC#PARAMS#EXTENSION */,
        "key": "JSDOC#PARAMS#EXTENSION",
        "placeholder": "$COMMENT#JSDOC#PARAMS#EXTENSION"
      },
      "node": {
        "value": "The ESLint `node` of the rule's current traversal." /* $COMMENT#JSDOC#PARAMS#NODE */,
      ...
      "agnostic20": {
        ...
        "ast": {
          "value": "The module's AST (Abstract Syntax Tree)." /* $COMMENT#JSDOC#PARAMS#AGNOSTIC20#AST */,
          "key": "JSDOC#PARAMS#AGNOSTIC20#AST",
          "placeholder": "$COMMENT#JSDOC#PARAMS#AGNOSTIC20#AST"
        },
        "directive": {
          "value": "The directive as written on top of the file (`\"no directive\"` if no valid directive)." /* $COMMENT#JSDOC#PARAMS#AGNOSTIC20#DIRECTIVE */,
          "key": "JSDOC#PARAMS#AGNOSTIC20#DIRECTIVE",
          "placeholder": "$COMMENT#JSDOC#PARAMS#AGNOSTIC20#DIRECTIVE"
        },
        "effectiveDirective": {
          "value": "The effective directive of the effective module." /* $COMMENT#JSDOC#PARAMS#AGNOSTIC20#EFFECTIVEDIRECTIVE */,
      ...
      "directive21": {
        ...
        "string": {
          "value": "The original string." /* $COMMENT#JSDOC#PARAMS#DIRECTIVE21#STRING */,
          "key": "JSDOC#PARAMS#DIRECTIVE21#STRING",
          "placeholder": "$COMMENT#JSDOC#PARAMS#DIRECTIVE21#STRING"
        },
        "sourceCode": {
          "value": "The ESLint SourceCode object." /* $COMMENT#JSDOC#PARAMS#DIRECTIVE21#SOURCECODE */,
          "key": "JSDOC#PARAMS#DIRECTIVE21#SOURCECODE",
          "placeholder": "$COMMENT#JSDOC#PARAMS#DIRECTIVE21#SOURCECODE"
        },
        "directive": {
          "value": "The commented directive as written on top of the file (cannot be `null` at that stage)." /* $COMMENT#JSDOC#PARAMS#DIRECTIVE21#DIRECTIVE */,
          "key": "JSDOC#PARAMS#DIRECTIVE21#DIRECTIVE",
          "placeholder": "$COMMENT#JSDOC#PARAMS#DIRECTIVE21#DIRECTIVE"
        },
        "commentedDirective": {
          "value": "The commented directive of the commented module." /* $COMMENT#JSDOC#PARAMS#DIRECTIVE21#COMMENTEDDIRECTIVE */,
      ...
      "tests": {
        "folderPath": {
          "value": "The provided directory." /* $COMMENT#JSDOC#PARAMS#TESTS#FOLDERPATH */,
          "key": "JSDOC#PARAMS#TESTS#FOLDERPATH",
          "placeholder": "$COMMENT#JSDOC#PARAMS#TESTS#FOLDERPATH"
        },
        "allFiles": {
          "value": "The accumulator array of file paths. Defaults to an empty array on the initial call, and is passed through each recursive call to be mutated and collect results." /* $COMMENT#JSDOC#PARAMS#TESTS#ALLFILES */,
          "key": "JSDOC#PARAMS#TESTS#ALLFILES",
          "placeholder": "$COMMENT#JSDOC#PARAMS#TESTS#ALLFILES"
        },
        "javaScriptErrorsLength": {
          "value": "The number of errors expected on JavaScript files." /* $COMMENT#JSDOC#PARAMS#TESTS#JAVASCRIPTERRORSLENGTH */,
        ...
        "typeScriptErrorsLength": {
          "value": "The number of errors expected on TypeScript files." /* $COMMENT#JSDOC#PARAMS#TESTS#TYPESCRIPTERRORSLENGTH */,
          "key": "JSDOC#PARAMS#TESTS#TYPESCRIPTERRORSLENGTH",
          "placeholder": "$COMMENT#JSDOC#PARAMS#TESTS#TYPESCRIPTERRORSLENGTH"
        },
        "messageId": {
          "value": "The messageId of the errors expected." /* $COMMENT#JSDOC#PARAMS#TESTS#MESSAGEID */,
    ...
    "details": {
      "agnostic20": {
        "nullDirective": {
          "value": "`null` denotes a server-by-default module, ideally a Server Module." /* $COMMENT#JSDOC#DETAILS#AGNOSTIC20#NULLDIRECTIVE */,
          "key": "JSDOC#DETAILS#AGNOSTIC20#NULLDIRECTIVE",
          "placeholder": "$COMMENT#JSDOC#DETAILS#AGNOSTIC20#NULLDIRECTIVE"
        },
        "useServer": {
          "value": "`'use server'` denotes a Server Functions Module." /* $COMMENT#JSDOC#DETAILS#AGNOSTIC20#USESERVER */,
          "key": "JSDOC#DETAILS#AGNOSTIC20#USESERVER",
          "placeholder": "$COMMENT#JSDOC#DETAILS#AGNOSTIC20#USESERVER"
        },
        "useClient": {
          "value": "`'use client'` denotes a Client Module." /* $COMMENT#JSDOC#DETAILS#AGNOSTIC20#USECLIENT */,
          "key": "JSDOC#DETAILS#AGNOSTIC20#USECLIENT",
          "placeholder": "$COMMENT#JSDOC#DETAILS#AGNOSTIC20#USECLIENT"
        },
        "useAgnostic": {
          "value": "`'use agnostic'` denotes an Agnostic Module (formerly Shared Module)." /* $COMMENT#JSDOC#DETAILS#AGNOSTIC20#USEAGNOSTIC */,
          "key": "JSDOC#DETAILS#AGNOSTIC20#USEAGNOSTIC",
          "placeholder": "$COMMENT#JSDOC#DETAILS#AGNOSTIC20#USEAGNOSTIC"
        },
        "useServerLogics": {
          "value": "`'use server logics'` denotes a Server Logics Module." /* $COMMENT#JSDOC#DETAILS#AGNOSTIC20#USESERVERLOGICS */,
          "key": "JSDOC#DETAILS#AGNOSTIC20#USESERVERLOGICS",
          "placeholder": "$COMMENT#JSDOC#DETAILS#AGNOSTIC20#USESERVERLOGICS"
        },
        "useServerComponents": {
          "value": "`'use server components'` denotes a Server Components Module." /* $COMMENT#JSDOC#DETAILS#AGNOSTIC20#USESERVERCOMPONENTS */,
          "key": "JSDOC#DETAILS#AGNOSTIC20#USESERVERCOMPONENTS",
          "placeholder": "$COMMENT#JSDOC#DETAILS#AGNOSTIC20#USESERVERCOMPONENTS"
        },
        "useServerFunctions": {
          "value": "`'use server functions'` denotes a Server Functions Module." /* $COMMENT#JSDOC#DETAILS#AGNOSTIC20#USESERVERFUNCTIONS */,
          "key": "JSDOC#DETAILS#AGNOSTIC20#USESERVERFUNCTIONS",
          "placeholder": "$COMMENT#JSDOC#DETAILS#AGNOSTIC20#USESERVERFUNCTIONS"
        },
        "useClientLogics": {
          "value": "`'use client logics'` denotes a Client Logics Module." /* $COMMENT#JSDOC#DETAILS#AGNOSTIC20#USECLIENTLOGICS */,
          "key": "JSDOC#DETAILS#AGNOSTIC20#USECLIENTLOGICS",
          "placeholder": "$COMMENT#JSDOC#DETAILS#AGNOSTIC20#USECLIENTLOGICS"
        },
        "useClientComponents": {
          "value": "`'use client components'` denotes a Client Components Module." /* $COMMENT#JSDOC#DETAILS#AGNOSTIC20#USECLIENTCOMPONENTS */,
          "key": "JSDOC#DETAILS#AGNOSTIC20#USECLIENTCOMPONENTS",
          "placeholder": "$COMMENT#JSDOC#DETAILS#AGNOSTIC20#USECLIENTCOMPONENTS"
        },
        "useAgnosticLogics": {
          "value": "`'use agnostic logics'` denotes an Agnostic Logics Module." /* $COMMENT#JSDOC#DETAILS#AGNOSTIC20#USEAGNOSTICLOGICS */,
        ...
        "useAgnosticComponents": {
          "value": "`'use agnostic components'` denotes an Agnostic Components Module." /* $COMMENT#JSDOC#DETAILS#AGNOSTIC20#USEAGNOSTICCOMPONENTS */,
      ...
      "directive21": {
        "useServerLogicsA": {
          "value": "`'use server logics'`, `\"use server logics\"` denoting a Server Logics Module." /* $COMMENT#JSDOC#DETAILS#DIRECTIVE21#USESERVERLOGICSA */,
          "key": "JSDOC#DETAILS#DIRECTIVE21#USESERVERLOGICSA",
          "placeholder": "$COMMENT#JSDOC#DETAILS#DIRECTIVE21#USESERVERLOGICSA"
        },
        "useClientLogicsA": {
          "value": "`'use client logics'`, `\"use client logics\"` denoting a Client Logics Module." /* $COMMENT#JSDOC#DETAILS#DIRECTIVE21#USECLIENTLOGICSA */,
          "key": "JSDOC#DETAILS#DIRECTIVE21#USECLIENTLOGICSA",
          "placeholder": "$COMMENT#JSDOC#DETAILS#DIRECTIVE21#USECLIENTLOGICSA"
        },
        "useAgnosticLogicsA": {
          "value": "`'use agnostic logics'`, `\"use agnostic logics\"` denoting an Agnostic Logics Module." /* $COMMENT#JSDOC#DETAILS#DIRECTIVE21#USEAGNOSTICLOGICSA */,
          "key": "JSDOC#DETAILS#DIRECTIVE21#USEAGNOSTICLOGICSA",
          "placeholder": "$COMMENT#JSDOC#DETAILS#DIRECTIVE21#USEAGNOSTICLOGICSA"
        },
        "useServerComponentsA": {
          "value": "`'use server components'`, `\"use server components\"` denoting a Server Components Module." /* $COMMENT#JSDOC#DETAILS#DIRECTIVE21#USESERVERCOMPONENTSA */,
        ...
        "useClientComponentsA": {
          "value": "`'use client components'`, `\"use client components\"` denoting a Client Components Module." /* $COMMENT#JSDOC#DETAILS#DIRECTIVE21#USECLIENTCOMPONENTSA */,
        ...
        "useAgnosticComponentsA": {
          "value": "`'use agnostic components'`, `\"use agnostic components\"` denoting an Agnostic Components Module." /* $COMMENT#JSDOC#DETAILS#DIRECTIVE21#USEAGNOSTICCOMPONENTSA */,
          "key": "JSDOC#DETAILS#DIRECTIVE21#USEAGNOSTICCOMPONENTSA",
          "placeholder": "$COMMENT#JSDOC#DETAILS#DIRECTIVE21#USEAGNOSTICCOMPONENTSA"
        },
        "useServerFunctionsA": {
          "value": "`'use server functions'`, `\"use server functions\"` denoting a Server Functions Module." /* $COMMENT#JSDOC#DETAILS#DIRECTIVE21#USESERVERFUNCTIONSA */,
          "key": "JSDOC#DETAILS#DIRECTIVE21#USESERVERFUNCTIONSA",
          "placeholder": "$COMMENT#JSDOC#DETAILS#DIRECTIVE21#USESERVERFUNCTIONSA"
        },
        "useClientContextsA": {
          "value": "`'use client contexts'`, `\"use client contexts\"` denoting a Client Contexts Module." /* $COMMENT#JSDOC#DETAILS#DIRECTIVE21#USECLIENTCONTEXTSA */,
        ...
        "useAgnosticConditionsA": {
          "value": "`'use agnostic conditions'`, `\"use agnostic conditions\"` denoting an Agnostic Conditions Module." /* $COMMENT#JSDOC#DETAILS#DIRECTIVE21#USEAGNOSTICCONDITIONSA */,
          "key": "JSDOC#DETAILS#DIRECTIVE21#USEAGNOSTICCONDITIONSA",
          "placeholder": "$COMMENT#JSDOC#DETAILS#DIRECTIVE21#USEAGNOSTICCONDITIONSA"
        },
        "useAgnosticStrategiesA": {
          "value": "`'use agnostic strategies'`, `\"use agnostic strategies\"` denoting an Agnostic Strategies Module." /* $COMMENT#JSDOC#DETAILS#DIRECTIVE21#USEAGNOSTICSTRATEGIESA */,
          "key": "JSDOC#DETAILS#DIRECTIVE21#USEAGNOSTICSTRATEGIESA",
          "placeholder": "$COMMENT#JSDOC#DETAILS#DIRECTIVE21#USEAGNOSTICSTRATEGIESA"
        },
        "useServerLogicsB": {
          "value": "`'use server logics'`: Server Logics Modules do NOT export JSX." /* $COMMENT#JSDOC#DETAILS#DIRECTIVE21#USESERVERLOGICSB */,
          "key": "JSDOC#DETAILS#DIRECTIVE21#USESERVERLOGICSB",
          "placeholder": "$COMMENT#JSDOC#DETAILS#DIRECTIVE21#USESERVERLOGICSB"
        },
        "useClientLogicsB": {
          "value": "`'use client logics'`: Client Logics Modules do NOT export JSX." /* $COMMENT#JSDOC#DETAILS#DIRECTIVE21#USECLIENTLOGICSB */,
          "key": "JSDOC#DETAILS#DIRECTIVE21#USECLIENTLOGICSB",
          "placeholder": "$COMMENT#JSDOC#DETAILS#DIRECTIVE21#USECLIENTLOGICSB"
        },
        "useAgnosticLogicsB": {
          "value": "`'use agnostic logics'`: Agnostic Logics Modules do NOT export JSX." /* $COMMENT#JSDOC#DETAILS#DIRECTIVE21#USEAGNOSTICLOGICSB */,
        ...
        "useServerComponentsB": {
          "value": "`'use server components'`: Server Components Modules ONLY export JSX." /* $COMMENT#JSDOC#DETAILS#DIRECTIVE21#USESERVERCOMPONENTSB */,
        ...
        "useClientComponentsB": {
          "value": "`'use client components'`: Client Components Modules ONLY export JSX." /* $COMMENT#JSDOC#DETAILS#DIRECTIVE21#USECLIENTCOMPONENTSB */,
          "key": "JSDOC#DETAILS#DIRECTIVE21#USECLIENTCOMPONENTSB",
          "placeholder": "$COMMENT#JSDOC#DETAILS#DIRECTIVE21#USECLIENTCOMPONENTSB"
        },
        "useAgnosticComponentsB": {
          "value": "`'use agnostic components'`: Agnostic Components Modules ONLY export JSX." /* $COMMENT#JSDOC#DETAILS#DIRECTIVE21#USEAGNOSTICCOMPONENTSB */,
          "key": "JSDOC#DETAILS#DIRECTIVE21#USEAGNOSTICCOMPONENTSB",
          "placeholder": "$COMMENT#JSDOC#DETAILS#DIRECTIVE21#USEAGNOSTICCOMPONENTSB"
        },
        "useServerFunctionsB": {
          "value": "`'use server functions'`: Server Functions Modules do NOT export JSX." /* $COMMENT#JSDOC#DETAILS#DIRECTIVE21#USESERVERFUNCTIONSB */,
          "key": "JSDOC#DETAILS#DIRECTIVE21#USESERVERFUNCTIONSB",
          "placeholder": "$COMMENT#JSDOC#DETAILS#DIRECTIVE21#USESERVERFUNCTIONSB"
        },
        "useClientContextsB": {
          "value": "`'use client contexts'`: Client Contexts Modules ONLY export JSX." /* $COMMENT#JSDOC#DETAILS#DIRECTIVE21#USECLIENTCONTEXTSB */,
        ...
        "useAgnosticConditionsB": {
          "value": "`'use agnostic conditions'`: Agnostic Conditions Modules ONLY export JSX." /* $COMMENT#JSDOC#DETAILS#DIRECTIVE21#USEAGNOSTICCONDITIONSB */,
        ...
        "useAgnosticStrategiesB": {
          "value": "`'use agnostic strategies'`: Agnostic Strategies Modules may export JSX." /* $COMMENT#JSDOC#DETAILS#DIRECTIVE21#USEAGNOSTICSTRATEGIESB */,
    ...
    "returns": {
      "makeTestFiles": {
        "value": "The paths of the files to be linted for agnostic20 and directive21." /* $COMMENT#JSDOC#RETURNS#MAKETESTFILES */,
        "key": "JSDOC#RETURNS#MAKETESTFILES",
        "placeholder": "$COMMENT#JSDOC#RETURNS#MAKETESTFILES"
      },
      "highlightFirstLineOfCode": {
        "value": "The `context.report` `loc`-compatible coordinates for the first line of code of a file." /* $COMMENT#JSDOC#RETURNS#HIGHLIGHTFIRSTLINEOFCODE */,
      ...
      "makeIntroForSpecificViolationMessage": {
        "value": "\"[Current file 'resolved' modules] are not allowed to import [imported file 'resolved' modules].\"" /* $COMMENT#JSDOC#RETURNS#MAKEINTROFORSPECIFICVIOLATIONMESSAGE */,
      ...
      "findSpecificViolationMessage": {
        "value": "The corresponding `message`." /* $COMMENT#JSDOC#RETURNS#FINDSPECIFICVIOLATIONMESSAGE */,
        "key": "JSDOC#RETURNS#FINDSPECIFICVIOLATIONMESSAGE" /* $COMMENT#JSDOC#RETURNS#FINDSPECIFICVIOLATIONMESSAGE */,
      ...
      "agnostic20": {
        ...
        "makeBlockedImport": {
          "value": "The blockedImport object for the identified blocked import at hand." /* $COMMENT#JSDOC#RETURNS#AGNOSTIC20#MAKEBLOCKEDIMPORT */,
          "key": "JSDOC#RETURNS#AGNOSTIC20#MAKEBLOCKEDIMPORT" /* $COMMENT#JSDOC#RETURNS#AGNOSTIC20#MAKEBLOCKEDIMPORT */,
          "placeholder": "$COMMENT#JSDOC#RETURNS#AGNOSTIC20#MAKEBLOCKEDIMPORT"
        },
        "makeBlockedImportSuggestingUseAgnostic": {
          "value": "The enhanced blockedImport object with the suggestion to use the `'use agnostic'` directive." /* $COMMENT#JSDOC#RETURNS#AGNOSTIC20#MAKEBLOCKEDIMPORTSUGGESTINGUSEAGNOSTIC */,
          "key": "JSDOC#RETURNS#AGNOSTIC20#MAKEBLOCKEDIMPORTSUGGESTINGUSEAGNOSTIC",
          "placeholder": "$COMMENT#JSDOC#RETURNS#AGNOSTIC20#MAKEBLOCKEDIMPORTSUGGESTINGUSEAGNOSTIC"
        },
        "getDirectiveFromModule": {
          "value": "The directive, or lack thereof via `null`. The lack of a directive is considered server-by-default." /* $COMMENT#JSDOC#RETURNS#AGNOSTIC20#GETDIRECTIVEFROMMODULE */,
          "key": "JSDOC#RETURNS#AGNOSTIC20#GETDIRECTIVEFROMMODULE" /* $COMMENT#JSDOC#RETURNS#AGNOSTIC20#GETDIRECTIVEFROMMODULE */,
        ...
        "getEffectiveDirective": {
          "value": "The effective directive, from which imports rules are applied." /* $COMMENT#JSDOC#RETURNS#AGNOSTIC20#GETEFFECTIVEDIRECTIVE */,
        ...
        "importsFlow": {
          "value": "Early if the flow needs to be interrupted." /* $COMMENT#JSDOC#FORALIASVARIABLES#FLOWRETURNSEARLY */,
      ...
      "directive21": {
        ...
        "detectQuoteType": {
          "value": "`true` if single-quoted, `false` if double-quoted, `null` if neither." /* $COMMENT#JSDOC#RETURNS#DIRECTIVE21#DETECTQUOTETYPE */,
          "key": "JSDOC#RETURNS#DIRECTIVE21#DETECTQUOTETYPE",
          "placeholder": "$COMMENT#JSDOC#RETURNS#DIRECTIVE21#DETECTQUOTETYPE"
        },
        "stripSingleQuotes": {
          "value": "The string with quotes removed." /* $COMMENT#JSDOC#RETURNS#DIRECTIVE21#STRIPSINGLEQUOTES */,
          "key": "JSDOC#RETURNS#DIRECTIVE21#STRIPSINGLEQUOTES" /* $COMMENT#JSDOC#RETURNS#DIRECTIVE21#STRIPSINGLEQUOTES */,
        ...
        "getCommentedDirectiveFromSourceCode": {
          "value": "The commented directive, or lack thereof via `null`. Given the strictness of this architecture, the lack of a directive is considered a mistake. (Though rules may provide the opportunity to declare a default, and configs with preset defaults may become provided.)" /* $COMMENT#JSDOC#RETURNS#DIRECTIVE21#GETCOMMENTEDDIRECTIVEFROMSOURCECODE */,
          "key": "JSDOC#RETURNS#DIRECTIVE21#GETCOMMENTEDDIRECTIVEFROMSOURCECODE" /* $COMMENT#JSDOC#RETURNS#DIRECTIVE21#GETCOMMENTEDDIRECTIVEFROMSOURCECODE */,
          "placeholder": "$COMMENT#JSDOC#RETURNS#DIRECTIVE21#GETCOMMENTEDDIRECTIVEFROMSOURCECODE"
        },
        "getCommentedDirectiveFromCurrentModule": {
          "value": "The commented directive, or lack thereof via `null`. Given the strictness of this architecture, the lack of a directive is considered a mistake. (Though rules may provide the opportunity to declare a default, and configs with preset defaults may become provided.)" /* $COMMENT#JSDOC#RETURNS#DIRECTIVE21#GETCOMMENTEDDIRECTIVEFROMSOURCECODE */,
        ...
        "getVerifiedCommentedDirective": {
          "value": "The verified commented directive, from which imports rules are applied. Returns `null` if the verification failed, upon which an error will be reported depending on the commented directive, since the error logic here is strictly binary." /* $COMMENT#JSDOC#RETURNS#DIRECTIVE21#GETVERIFIEDCOMMENTEDDIRECTIVE */,
        ...
        "getStrategizedDirective": {
          "value": "The interpreted directive, a.k.a. strategized directive, or lack thereof via `null`." /* $COMMENT#JSDOC#RETURNS#DIRECTIVE21#GETSTRATEGIZEDDIRECTIVE */,
          "key": "JSDOC#RETURNS#DIRECTIVE21#GETSTRATEGIZEDDIRECTIVE",
          "placeholder": "$COMMENT#JSDOC#RETURNS#DIRECTIVE21#GETSTRATEGIZEDDIRECTIVE"
        },
        "addressDirectiveIfAgnosticStrategies": {
          "value": "The commented directive, the addressed strategy (as a commented directive) or `null` in case of failure." /* $COMMENT#JSDOC#RETURNS#DIRECTIVE21#ADDRESSDIRECTIVEIFAGNOSTICSTRATEGIES */,
      ...
      "tests": {
        "readFilesRecursively": {
          "value": "All files at any depths within the provided directory." /* $COMMENT#JSDOC#RETURNS#TESTS#READFILESRECURSIVELY */,
    ...
    "forComposedVariables": {
      ...
      "getCommentedDirective": {
        "value": "Gets the commented directive of the" /* $COMMENT#JSDOC#FORCOMPOSEDVARIABLES#GETCOMMENTEDDIRECTIVE */,
        "key": "JSDOC#FORCOMPOSEDVARIABLES#GETCOMMENTEDDIRECTIVE",
        "placeholder": "$COMMENT#JSDOC#FORCOMPOSEDVARIABLES#GETCOMMENTEDDIRECTIVE"
      },
      "currentModulePeriod": {
        "value": "current module." /* $COMMENT#JSDOC#FORCOMPOSEDVARIABLES#CURRENTMODULEPERIOD */,
      ...
      "withNeededProperties": {
        "value": "with needed properties" /* $COMMENT#JSDOC#FORCOMPOSEDVARIABLES#WITHNEEDEDPROPERTIES */,
      ...
      "withNeededPropertiesPeriod": {
        "value": "with needed properties." /* $COMMENT#JSDOC#FORCOMPOSEDVARIABLES#WITHNEEDEDPROPERTIESPERIOD */,
      ...
      "theCurrentFile": {
        "value": "The current file's" /* $COMMENT#JSDOC#FORCOMPOSEDVARIABLES#THECURRENTFILE */,
        "key": "JSDOC#FORCOMPOSEDVARIABLES#THECURRENTFILE",
        "placeholder": "$COMMENT#JSDOC#FORCOMPOSEDVARIABLES#THECURRENTFILE"
      },
      "theImportedFile": {
        "value": "The imported file's" /* $COMMENT#JSDOC#FORCOMPOSEDVARIABLES#THEIMPORTEDFILE */,
        "key": "JSDOC#FORCOMPOSEDVARIABLES#THEIMPORTEDFILE",
        "placeholder": "$COMMENT#JSDOC#FORCOMPOSEDVARIABLES#THEIMPORTEDFILE"
      },
      "eitherSkipTrueNonNull": {
        "value": "Either an object with `skip: true` to disregard or one with the non-null" /* $COMMENT#JSDOC#FORCOMPOSEDVARIABLES#EITHERSKIPTRUENONNULL */,
        "key": "JSDOC#FORCOMPOSEDVARIABLES#EITHERSKIPTRUENONNULL",
        "placeholder": "$COMMENT#JSDOC#FORCOMPOSEDVARIABLES#EITHERSKIPTRUENONNULL"
      },
      "cfedPeriod": {
        "value": "`currentFileEffectiveDirective`." /* $COMMENT#JSDOC#FORCOMPOSEDVARIABLES#CFEDPERIOD */,
        "key": "JSDOC#FORCOMPOSEDVARIABLES#CFEDPERIOD",
        "placeholder": "$COMMENT#JSDOC#FORCOMPOSEDVARIABLES#CFEDPERIOD"
      },
      "ifedPeriod": {
        "value": "`importedFileEffectiveDirective`." /* $COMMENT#JSDOC#FORCOMPOSEDVARIABLES#IFEDPERIOD */,
        "key": "JSDOC#FORCOMPOSEDVARIABLES#IFEDPERIOD",
        "placeholder": "$COMMENT#JSDOC#FORCOMPOSEDVARIABLES#IFEDPERIOD"
      },
      "vcdPeriod": {
        "value": "`verifiedCommentedDirective`." /* $COMMENT#JSDOC#FORCOMPOSEDVARIABLES#VCDPERIOD */,
        "key": "JSDOC#FORCOMPOSEDVARIABLES#VCDPERIOD",
        "placeholder": "$COMMENT#JSDOC#FORCOMPOSEDVARIABLES#VCDPERIOD"
      },
      "ifcdPeriod": {
        "value": "`importedFileCommentedDirective`." /* $COMMENT#JSDOC#FORCOMPOSEDVARIABLES#IFCDPERIOD */,
  ...
  "tests": {
    ...
    "forComposedVariables": {
      ...
      "withExtensionParentheses": {
        "value": "(with extension)." /* $COMMENT#TESTS#FORCOMPOSEDVARIABLES#WITHEXTENSIONPARENTHESES */,
        "key": "TESTS#FORCOMPOSEDVARIABLES#WITHEXTENSIONPARENTHESES",
        "placeholder": "$COMMENT#TESTS#FORCOMPOSEDVARIABLES#WITHEXTENSIONPARENTHESES"
      },
      "byFolder": {
        "value": "by a folder." /* $COMMENT#TESTS#FORCOMPOSEDVARIABLES#BYFOLDER */,
        "key": "TESTS#FORCOMPOSEDVARIABLES#BYFOLDER",
        "placeholder": "$COMMENT#TESTS#FORCOMPOSEDVARIABLES#BYFOLDER"
      },
      "importing": {
        "value": "...Importing" /* $COMMENT#TESTS#FORCOMPOSEDVARIABLES#IMPORTING */,
        "key": "TESTS#FORCOMPOSEDVARIABLES#IMPORTING",
        "placeholder": "$COMMENT#TESTS#FORCOMPOSEDVARIABLES#IMPORTING"
      },
      "viaStrategyPeriod": {
        "value": "via Special Agnostic Strategy." /* $COMMENT#TESTS#FORCOMPOSEDVARIABLES#VIASTRATEGYPERIOD */,
        "key": "TESTS#FORCOMPOSEDVARIABLES#VIASTRATEGYPERIOD",
        "placeholder": "$COMMENT#TESTS#FORCOMPOSEDVARIABLES#VIASTRATEGYPERIOD"
      },
      "viaStrategy": {
        "value": "via Special Agnostic Strategy" /* $COMMENT#TESTS#FORCOMPOSEDVARIABLES#VIASTRATEGY */,
  ...
  "agnostic20": {
    "use server logics": {
      ...
      "kinds": {
        "value": "Server Logics" /* $COMMENT#AGNOSTIC20#USE_SERVER_LOGICS#KINDS */,
        "key": "AGNOSTIC20#USE_SERVER_LOGICS#KINDS",
        "placeholder": "$COMMENT#AGNOSTIC20#USE_SERVER_LOGICS#KINDS"
      },
      "kindsComma": {
        "value": "Server Logics," /* $COMMENT#AGNOSTIC20#USE_SERVER_LOGICS#KINDSCOMMA */,
        "key": "AGNOSTIC20#USE_SERVER_LOGICS#KINDSCOMMA",
        "placeholder": "$COMMENT#AGNOSTIC20#USE_SERVER_LOGICS#KINDSCOMMA"
      },
      "kindsPeriod": {
        "value": "Server Logics." /* $COMMENT#AGNOSTIC20#USE_SERVER_LOGICS#KINDSPERIOD */,
      ...
      "directive": {
        "value": "use server logics" /* $COMMENT#AGNOSTIC20#USE_SERVER_LOGICS#DIRECTIVE */,
        "key": "AGNOSTIC20#USE_SERVER_LOGICS#DIRECTIVE",
        "placeholder": "$COMMENT#AGNOSTIC20#USE_SERVER_LOGICS#DIRECTIVE"
      },
      "module": {
        "value": "Server Logics Module",
        "key": "AGNOSTIC20#USE_SERVER_LOGICS#MODULE",
        "placeholder": "$COMMENT#AGNOSTIC20#USE_SERVER_LOGICS#MODULE"
      }
    },
    "use server components": {
      "use server logics": {
      ...
      "use server components": {
        "value": "Server Components can compose with one another, assuming thanks to the inclusion of the 'use agnostic' directive that they are actual Server Components." /* $COMMENT#AGNOSTIC20#USE_SERVER_COMPONENTS#USE_SERVER_COMPONENTS */,
      ...
      "use agnostic components": {
        "value": "Agnostic Components can render safely on the server just like they can on the client." /* $COMMENT#AGNOSTIC20#USE_SERVER_COMPONENTS#USE_AGNOSTIC_COMPONENTS */,
        "key": "AGNOSTIC20#USE_SERVER_COMPONENTS#USE_AGNOSTIC_COMPONENTS",
        "placeholder": "$COMMENT#AGNOSTIC20#USE_SERVER_COMPONENTS#USE_AGNOSTIC_COMPONENTS"
      },
      "kinds": {
        "value": "Server Components" /* $COMMENT#AGNOSTIC20#USE_SERVER_COMPONENTS#KINDS */,
        "key": "AGNOSTIC20#USE_SERVER_COMPONENTS#KINDS",
        "placeholder": "$COMMENT#AGNOSTIC20#USE_SERVER_COMPONENTS#KINDS"
      },
      "kindsComma": {
        "value": "Server Components," /* $COMMENT#AGNOSTIC20#USE_SERVER_COMPONENTS#KINDSCOMMA */,
        "key": "AGNOSTIC20#USE_SERVER_COMPONENTS#KINDSCOMMA",
        "placeholder": "$COMMENT#AGNOSTIC20#USE_SERVER_COMPONENTS#KINDSCOMMA"
      },
      "kindsPeriod": {
        "value": "Server Components." /* $COMMENT#AGNOSTIC20#USE_SERVER_COMPONENTS#KINDSPERIOD */,
    ...
    "use server functions": {
      ...
      "kinds": {
        "value": "Server Functions" /* $COMMENT#AGNOSTIC20#USE_SERVER_FUNCTIONS#KINDS */,
        "key": "AGNOSTIC20#USE_SERVER_FUNCTIONS#KINDS",
        "placeholder": "$COMMENT#AGNOSTIC20#USE_SERVER_FUNCTIONS#KINDS"
      },
      "kindsComma": {
        "value": "Server Functions," /* $COMMENT#AGNOSTIC20#USE_SERVER_FUNCTIONS#KINDSCOMMA */,
        "key": "AGNOSTIC20#USE_SERVER_FUNCTIONS#KINDSCOMMA",
        "placeholder": "$COMMENT#AGNOSTIC20#USE_SERVER_FUNCTIONS#KINDSCOMMA"
      },
      "kindsPeriod": {
        "value": "Server Functions." /* $COMMENT#AGNOSTIC20#USE_SERVER_FUNCTIONS#KINDSPERIOD */,
    ...
    "use client logics": {
      ...
      "use server functions": {
        "value": "Server Functions can technically be attached to Client Components that are being tinkered with within Client Logics Modules." /* $COMMENT#AGNOSTIC20#USE_CLIENT_LOGICS#USE_SERVER_FUNCTIONS */,
      ...
      "kinds": {
        "value": "Client Logics" /* $COMMENT#AGNOSTIC20#USE_CLIENT_LOGICS#KINDS */,
        "key": "AGNOSTIC20#USE_CLIENT_LOGICS#KINDS",
        "placeholder": "$COMMENT#AGNOSTIC20#USE_CLIENT_LOGICS#KINDS"
      },
      "kindsComma": {
        "value": "Client Logics," /* $COMMENT#AGNOSTIC20#USE_CLIENT_LOGICS#KINDSCOMMA */,
        "key": "AGNOSTIC20#USE_CLIENT_LOGICS#KINDSCOMMA",
        "placeholder": "$COMMENT#AGNOSTIC20#USE_CLIENT_LOGICS#KINDSCOMMA"
      },
      "kindsPeriod": {
        "value": "Client Logics." /* $COMMENT#AGNOSTIC20#USE_CLIENT_LOGICS#KINDSPERIOD */,
    ...
    "use client components": {
      ...
      "use server components": {
        "value": "Server Components may only pass through Client Components via the children prop within Server Components Modules." /* $COMMENT#AGNOSTIC20#USE_CLIENT_COMPONENTS#USE_SERVER_COMPONENTS */,
        "key": "AGNOSTIC20#USE_CLIENT_COMPONENTS#USE_SERVER_COMPONENTS",
        "placeholder": "$COMMENT#AGNOSTIC20#USE_CLIENT_COMPONENTS#USE_SERVER_COMPONENTS"
      },
      "use server functions": {
        "value": "Server Functions can specifically be triggered by Client Components." /* $COMMENT#AGNOSTIC20#USE_CLIENT_COMPONENTS#USE_SERVER_FUNCTIONS */,
      ...
      "use agnostic components": {
        "value": "Agnostic Components can render safely on the client just like they can on the server." /* $COMMENT#AGNOSTIC20#USE_CLIENT_COMPONENTS#USE_AGNOSTIC_COMPONENTS */,
      ...
      "kinds": {
        "value": "Client Components" /* $COMMENT#AGNOSTIC20#USE_CLIENT_COMPONENTS#KINDS */,
        "key": "AGNOSTIC20#USE_CLIENT_COMPONENTS#KINDS",
        "placeholder": "$COMMENT#AGNOSTIC20#USE_CLIENT_COMPONENTS#KINDS"
      },
      "kindsComma": {
        "value": "Client Components," /* $COMMENT#AGNOSTIC20#USE_CLIENT_COMPONENTS#KINDSCOMMA */,
        "key": "AGNOSTIC20#USE_CLIENT_COMPONENTS#KINDSCOMMA",
        "placeholder": "$COMMENT#AGNOSTIC20#USE_CLIENT_COMPONENTS#KINDSCOMMA"
      },
      "kindsPeriod": {
        "value": "Client Components." /* $COMMENT#AGNOSTIC20#USE_CLIENT_COMPONENTS#KINDSPERIOD */,
    ...
    "use agnostic logics": {
      ...
      "use server functions": {
        "value": "Server Functions can be modified on the server and on the client, but their use cases on both environments are not one-to-one compatible, since they're being addressed as they are on the server and addressed as references on the client." /* $COMMENT#AGNOSTIC20#USE_AGNOSTIC_LOGICS#USE_SERVER_FUNCTIONS */,
      ...
      "kinds": {
        "value": "Agnostic Logics" /* $COMMENT#AGNOSTIC20#USE_AGNOSTIC_LOGICS#KINDS */,
        "key": "AGNOSTIC20#USE_AGNOSTIC_LOGICS#KINDS",
        "placeholder": "$COMMENT#AGNOSTIC20#USE_AGNOSTIC_LOGICS#KINDS"
      },
      "kindsComma": {
        "value": "Agnostic Logics," /* $COMMENT#AGNOSTIC20#USE_AGNOSTIC_LOGICS#KINDSCOMMA */,
        "key": "AGNOSTIC20#USE_AGNOSTIC_LOGICS#KINDSCOMMA",
        "placeholder": "$COMMENT#AGNOSTIC20#USE_AGNOSTIC_LOGICS#KINDSCOMMA"
      },
      "kindsPeriod": {
        "value": "Agnostic Logics." /* $COMMENT#AGNOSTIC20#USE_AGNOSTIC_LOGICS#KINDSPERIOD */,
    ...
    "use agnostic components": {
      ...
      "use server functions": {
        "value": "Server Functions can be passed to Client Components as props when Client Components are also legally imported into Agnostic Components Modules." /* $COMMENT#AGNOSTIC20#USE_AGNOSTIC_COMPONENTS#USE_SERVER_FUNCTIONS */,
      ...
      "kinds": {
        "value": "Agnostic Components" /* $COMMENT#AGNOSTIC20#USE_AGNOSTIC_COMPONENTS#KINDS */,
        "key": "AGNOSTIC20#USE_AGNOSTIC_COMPONENTS#KINDS",
        "placeholder": "$COMMENT#AGNOSTIC20#USE_AGNOSTIC_COMPONENTS#KINDS"
      },
      "kindsComma": {
        "value": "Agnostic Components," /* $COMMENT#AGNOSTIC20#USE_AGNOSTIC_COMPONENTS#KINDSCOMMA */,
        "key": "AGNOSTIC20#USE_AGNOSTIC_COMPONENTS#KINDSCOMMA",
        "placeholder": "$COMMENT#AGNOSTIC20#USE_AGNOSTIC_COMPONENTS#KINDSCOMMA"
      },
      "kindsPeriod": {
        "value": "Agnostic Components." /* $COMMENT#AGNOSTIC20#USE_AGNOSTIC_COMPONENTS#KINDSPERIOD */,
    ...
    "forAliasVariables": {
      "serverNeverClient": {
        "value": "Server Logics should never leak to the client.",
        "key": "AGNOSTIC20#FORALIASVARIABLES#SERVERNEVERCLIENT" /* $COMMENT#AGNOSTIC20#FORALIASVARIABLES#SERVERNEVERCLIENT */,
        "placeholder": "$COMMENT#AGNOSTIC20#FORALIASVARIABLES#SERVERNEVERCLIENT"
      },
      "clientNeverServer": {
        "value": "Client Logics should never leak to the server.",
        "key": "AGNOSTIC20#FORALIASVARIABLES#CLIENTNEVERSERVER" /* $COMMENT#AGNOSTIC20#FORALIASVARIABLES#CLIENTNEVERSERVER */,
        "placeholder": "$COMMENT#AGNOSTIC20#FORALIASVARIABLES#CLIENTNEVERSERVER"
      },
      "agnosticCanServerClient": {
        "value": "Agnostic Logics can run safely on the server just like they can on the client.",
        "key": "AGNOSTIC20#FORALIASVARIABLES#AGNOSTICCANSERVERCLIENT" /* $COMMENT#AGNOSTIC20#FORALIASVARIABLES#AGNOSTICCANSERVERCLIENT */,
        "placeholder": "$COMMENT#AGNOSTIC20#FORALIASVARIABLES#AGNOSTICCANSERVERCLIENT"
      },
      "agnosticCanClientServer": {
        "value": "Agnostic Logics can run safely on the client just like they can on the server.",
        "key": "AGNOSTIC20#FORALIASVARIABLES#AGNOSTICCANCLIENTSERVER" /* $COMMENT#AGNOSTIC20#FORALIASVARIABLES#AGNOSTICCANCLIENTSERVER */,
        "placeholder": "$COMMENT#AGNOSTIC20#FORALIASVARIABLES#AGNOSTICCANCLIENTSERVER"
      },
      "serverFunctionsNoComponents": {
        "value": "Server Functions have no business working with React Components." /* $COMMENT#AGNOSTIC20#FORALIASVARIABLES#SERVERFUNCTIONSNOCOMPONENTS */,
      ...
      "serverLogicsCantBoth": {
        "value": "Server Logics cannot run on both the server and the client.",
        "key": "AGNOSTIC20#FORALIASVARIABLES#SERVERLOGICSCANTBOTH" /* $COMMENT#AGNOSTIC20#FORALIASVARIABLES#SERVERLOGICSCANTBOTH */,
        "placeholder": "$COMMENT#AGNOSTIC20#FORALIASVARIABLES#SERVERLOGICSCANTBOTH"
      },
      "clientLogicsCantBoth": {
        "value": "Client Logics cannot run on both the server and the client.",
        "key": "AGNOSTIC20#FORALIASVARIABLES#CLIENTLOGICSCANTBOTH" /* $COMMENT#AGNOSTIC20#FORALIASVARIABLES#CLIENTLOGICSCANTBOTH */,
        "placeholder": "$COMMENT#AGNOSTIC20#FORALIASVARIABLES#CLIENTLOGICSCANTBOTH"
      }
    },
    "forComposedVariables": {
      "shouldNeverClient": {
        "value": "should never leak to the client." /* $COMMENT#AGNOSTIC20#FORCOMPOSEDVARIABLES#SHOULDNEVERCLIENT */,
        "key": "AGNOSTIC20#FORCOMPOSEDVARIABLES#SHOULDNEVERCLIENT" /* $COMMENT#AGNOSTIC20#FORCOMPOSEDVARIABLES#SHOULDNEVERCLIENT */,
        "placeholder": "$COMMENT#AGNOSTIC20#FORCOMPOSEDVARIABLES#SHOULDNEVERCLIENT"
      },
      "shouldNeverServer": {
        "value": "should never leak to the server." /* $COMMENT#AGNOSTIC20#FORCOMPOSEDVARIABLES#SHOULDNEVERSERVER */,
        "key": "AGNOSTIC20#FORCOMPOSEDVARIABLES#SHOULDNEVERSERVER" /* $COMMENT#AGNOSTIC20#FORCOMPOSEDVARIABLES#SHOULDNEVERSERVER */,
        "placeholder": "$COMMENT#AGNOSTIC20#FORCOMPOSEDVARIABLES#SHOULDNEVERSERVER"
      },
      "runServerLikeClient": {
        "value": "can run safely on the server just like they can on the client." /* $COMMENT#AGNOSTIC20#FORCOMPOSEDVARIABLES#RUNSERVERLIKECLIENT */,
        "key": "AGNOSTIC20#FORCOMPOSEDVARIABLES#RUNSERVERLIKECLIENT" /* $COMMENT#AGNOSTIC20#FORCOMPOSEDVARIABLES#RUNSERVERLIKECLIENT */,
        "placeholder": "$COMMENT#AGNOSTIC20#FORCOMPOSEDVARIABLES#RUNSERVERLIKECLIENT"
      },
      "runClientLikeServer": {
        "value": "can run safely on the client just like they can on the server." /* $COMMENT#AGNOSTIC20#FORCOMPOSEDVARIABLES#RUNCLIENTLIKESERVER */,
        "key": "AGNOSTIC20#FORCOMPOSEDVARIABLES#RUNCLIENTLIKESERVER" /* $COMMENT#AGNOSTIC20#FORCOMPOSEDVARIABLES#RUNCLIENTLIKESERVER */,
        "placeholder": "$COMMENT#AGNOSTIC20#FORCOMPOSEDVARIABLES#RUNCLIENTLIKESERVER"
      },
      "canComposeOneAnother": {
        "value": "can compose with one another." /* $COMMENT#AGNOSTIC20#FORCOMPOSEDVARIABLES#CANCOMPOSEONEANOTHER */,
        "key": "AGNOSTIC20#FORCOMPOSEDVARIABLES#CANCOMPOSEONEANOTHER" /* $COMMENT#AGNOSTIC20#FORCOMPOSEDVARIABLES#CANCOMPOSEONEANOTHER */,
        "placeholder": "$COMMENT#AGNOSTIC20#FORCOMPOSEDVARIABLES#CANCOMPOSEONEANOTHER"
      },
      "cantTinkeredServer": {
        "value": "cannot be tinkered with on the server." /* $COMMENT#AGNOSTIC20#FORCOMPOSEDVARIABLES#CANTTINKEREDSERVER */,
        "key": "AGNOSTIC20#FORCOMPOSEDVARIABLES#CANTTINKEREDSERVER" /* $COMMENT#AGNOSTIC20#FORCOMPOSEDVARIABLES#CANTTINKEREDSERVER */,
        "placeholder": "$COMMENT#AGNOSTIC20#FORCOMPOSEDVARIABLES#CANTTINKEREDSERVER"
      },
      "cantTinkeredClient": {
        "value": "cannot be tinkered with on the client." /* $COMMENT#AGNOSTIC20#FORCOMPOSEDVARIABLES#CANTTINKEREDCLIENT */,
        "key": "AGNOSTIC20#FORCOMPOSEDVARIABLES#CANTTINKEREDCLIENT" /* $COMMENT#AGNOSTIC20#FORCOMPOSEDVARIABLES#CANTTINKEREDCLIENT */,
        "placeholder": "$COMMENT#AGNOSTIC20#FORCOMPOSEDVARIABLES#CANTTINKEREDCLIENT"
      },
      "cantTinkeredBoth": {
        "value": "cannot be tinkered with on both the server and the client." /* $COMMENT#AGNOSTIC20#FORCOMPOSEDVARIABLES#CANTTINKEREDBOTH */,
        "key": "AGNOSTIC20#FORCOMPOSEDVARIABLES#CANTTINKEREDBOTH" /* $COMMENT#AGNOSTIC20#FORCOMPOSEDVARIABLES#CANTTINKEREDBOTH */,
        "placeholder": "$COMMENT#AGNOSTIC20#FORCOMPOSEDVARIABLES#CANTTINKEREDBOTH"
      },
      "serverComponentsOKLogics": {
        "value": "Server Components are OK to be composed with Server Logics as long as the Server Logics Module," /* $COMMENT#AGNOSTIC20#FORCOMPOSEDVARIABLES#SERVERCOMPONENTSOKLOGICS */,
      ...
      "clientComponentsOKLogics": {
        "value": "Client Components are OK to be composed with Client Logics as long as the Client Logics Module," /* $COMMENT#AGNOSTIC20#FORCOMPOSEDVARIABLES#CLIENTCOMPONENTSOKLOGICS */,
      ...
      "agnosticComponentsCanServer": {
        "value": "Agnostic Components can be composed with Logics on the server just like they can on the client, as long at the Server Logics Module," /* $COMMENT#AGNOSTIC20#FORCOMPOSEDVARIABLES#AGNOSTICCOMPONENTSCANSERVER */,
      ...
      "agnosticComponentsCanClient": {
        "value": "Agnostic Components can be composed with Logics on the client just like they can on the server, as long as the Client Logics Module," /* $COMMENT#AGNOSTIC20#FORCOMPOSEDVARIABLES#AGNOSTICCOMPONENTSCANCLIENT */,
      ...
      "agnosticComponentsCanAgnostic": {
        "value": "Agnostic Components can be composed with Logics agnostically as long as the Agnostic Logics Module," /* $COMMENT#AGNOSTIC20#FORCOMPOSEDVARIABLES#AGNOSTICCOMPONENTSCANAGNOSTIC */,
      ...
      "noExportComponents": {
        "value": "by convention, does not export React components." /* $COMMENT#AGNOSTIC20#FORCOMPOSEDVARIABLES#NOEXPORTCOMPONENTS */,
        "key": "AGNOSTIC20#FORCOMPOSEDVARIABLES#NOEXPORTCOMPONENTS" /* $COMMENT#AGNOSTIC20#FORCOMPOSEDVARIABLES#NOEXPORTCOMPONENTS */,
        "placeholder": "$COMMENT#AGNOSTIC20#FORCOMPOSEDVARIABLES#NOEXPORTCOMPONENTS"
      },
      "cantServerClient": {
        "value": "cannot run on both the server and the client." /* $COMMENT#AGNOSTIC20#FORCOMPOSEDVARIABLES#CANTSERVERCLIENT */,
        "key": "AGNOSTIC20#FORCOMPOSEDVARIABLES#CANTSERVERCLIENT" /* $COMMENT#AGNOSTIC20#FORCOMPOSEDVARIABLES#CANTSERVERCLIENT */,
        "placeholder": "$COMMENT#AGNOSTIC20#FORCOMPOSEDVARIABLES#CANTSERVERCLIENT"
      },
      "arentAllowed": {
        "value": "aren't allowed because" /* $COMMENT#AGNOSTIC20#FORCOMPOSEDVARIABLES#ARENTALLOWED */,
        "key": "AGNOSTIC20#FORCOMPOSEDVARIABLES#ARENTALLOWED" /* $COMMENT#AGNOSTIC20#FORCOMPOSEDVARIABLES#ARENTALLOWED */,
        "placeholder": "$COMMENT#AGNOSTIC20#FORCOMPOSEDVARIABLES#ARENTALLOWED"
      },
      "allowedBecause": {
        "value": "allowed, because" /* $COMMENT#AGNOSTIC20#FORCOMPOSEDVARIABLES#ALLOWEDBECAUSE */,
        "key": "AGNOSTIC20#FORCOMPOSEDVARIABLES#ALLOWEDBECAUSE" /* $COMMENT#AGNOSTIC20#FORCOMPOSEDVARIABLES#ALLOWEDBECAUSE */,
        "placeholder": "$COMMENT#AGNOSTIC20#FORCOMPOSEDVARIABLES#ALLOWEDBECAUSE"
      },
      "beingLogicServer": {
        "value": "being logic from the server," /* $COMMENT#AGNOSTIC20#FORCOMPOSEDVARIABLES#BEINGLOGICSERVER */,
        "key": "AGNOSTIC20#FORCOMPOSEDVARIABLES#BEINGLOGICSERVER" /* $COMMENT#AGNOSTIC20#FORCOMPOSEDVARIABLES#BEINGLOGICSERVER */,
        "placeholder": "$COMMENT#AGNOSTIC20#FORCOMPOSEDVARIABLES#BEINGLOGICSERVER"
      },
      "beingLogicClient": {
        "value": "being logic from the client," /* $COMMENT#AGNOSTIC20#FORCOMPOSEDVARIABLES#BEINGLOGICCLIENT */,
        "key": "AGNOSTIC20#FORCOMPOSEDVARIABLES#BEINGLOGICCLIENT" /* $COMMENT#AGNOSTIC20#FORCOMPOSEDVARIABLES#BEINGLOGICCLIENT */,
        "placeholder": "$COMMENT#AGNOSTIC20#FORCOMPOSEDVARIABLES#BEINGLOGICCLIENT"
      },
      "beingLogicAgnostic": {
        "value": "being environment-agnostic logic," /* $COMMENT#AGNOSTIC20#FORCOMPOSEDVARIABLES#BEINGLOGICAGNOSTIC */,
        "key": "AGNOSTIC20#FORCOMPOSEDVARIABLES#BEINGLOGICAGNOSTIC" /* $COMMENT#AGNOSTIC20#FORCOMPOSEDVARIABLES#BEINGLOGICAGNOSTIC */,
        "placeholder": "$COMMENT#AGNOSTIC20#FORCOMPOSEDVARIABLES#BEINGLOGICAGNOSTIC"
      },
      "canSafelySupport": {
        "value": "can safely support" /* $COMMENT#AGNOSTIC20#FORCOMPOSEDVARIABLES#CANSAFELYSUPPORT */,
        "key": "AGNOSTIC20#FORCOMPOSEDVARIABLES#CANSAFELYSUPPORT" /* $COMMENT#AGNOSTIC20#FORCOMPOSEDVARIABLES#CANSAFELYSUPPORT */,
        "placeholder": "$COMMENT#AGNOSTIC20#FORCOMPOSEDVARIABLES#CANSAFELYSUPPORT"
      },
      "canBeNestedInside": {
        "value": "can be nested inside" /* $COMMENT#AGNOSTIC20#FORCOMPOSEDVARIABLES#CANBENESTEDINSIDE */,
        "key": "AGNOSTIC20#FORCOMPOSEDVARIABLES#CANBENESTEDINSIDE" /* $COMMENT#AGNOSTIC20#FORCOMPOSEDVARIABLES#CANBENESTEDINSIDE */,
        "placeholder": "$COMMENT#AGNOSTIC20#FORCOMPOSEDVARIABLES#CANBENESTEDINSIDE"
      },
      "eitherWrapTree": {
        "value": "either to wrap some of the tree with client state accessible through child Client Components and pass through Server Components" /* $COMMENT#AGNOSTIC20#FORCOMPOSEDVARIABLES#EITHERWRAPTREE */,
        "key": "AGNOSTIC20#FORCOMPOSEDVARIABLES#EITHERWRAPTREE",
        "placeholder": "$COMMENT#AGNOSTIC20#FORCOMPOSEDVARIABLES#EITHERWRAPTREE"
      },
      "ifStillOnServerTree": {
        "value": "— if still on the Server Tree —" /* $COMMENT#AGNOSTIC20#FORCOMPOSEDVARIABLES#IFSTILLONSERVERTREE */,
        "key": "AGNOSTIC20#FORCOMPOSEDVARIABLES#IFSTILLONSERVERTREE" /* $COMMENT#AGNOSTIC20#FORCOMPOSEDVARIABLES#IFSTILLONSERVERTREE */,
        "placeholder": "$COMMENT#AGNOSTIC20#FORCOMPOSEDVARIABLES#IFSTILLONSERVERTREE"
      },
      "orCreateBoundaries": {
        "value": "or to create client boundaries when the root of the application is planted on the server." /* $COMMENT#AGNOSTIC20#FORCOMPOSEDVARIABLES#ORCREATEBOUNDARIES */,
  ...
  "directive21": {
    "use server logics": {
      ...
      "use agnostic conditions": {
        "value": "(Special) Agnostic Conditions Components are able to safely render on the server, guaranteeing that only their `ComponentForServer` will be effectively involved in Prime Server Logics Modules." /* $COMMENT#DIRECTIVE21#USE_SERVER_LOGICS#USE_AGNOSTIC_CONDITIONS */,
      ...
      "kinds": {
        "value": "Prime Server Logics" /* $COMMENT#DIRECTIVE21#USE_SERVER_LOGICS#KINDS */,
        "key": "DIRECTIVE21#USE_SERVER_LOGICS#KINDS",
        "placeholder": "$COMMENT#DIRECTIVE21#USE_SERVER_LOGICS#KINDS"
      },
      "kindsComma": {
        "value": "Prime Server Logics," /* $COMMENT#DIRECTIVE21#USE_SERVER_LOGICS#KINDSCOMMA */,
        "key": "DIRECTIVE21#USE_SERVER_LOGICS#KINDSCOMMA",
        "placeholder": "$COMMENT#DIRECTIVE21#USE_SERVER_LOGICS#KINDSCOMMA"
      },
      "kindsPeriod": {
        "value": "Prime Server Logics." /* $COMMENT#DIRECTIVE21#USE_SERVER_LOGICS#KINDSPERIOD */,
    ...
    "use client logics": {
      ...
      "use server functions": {
        "value": "(Special) Server Functions can technically be attached to any Client Components that are being tinkered with within Client Logics Modules." /* $COMMENT#DIRECTIVE21#USE_CLIENT_LOGICS#USE_SERVER_FUNCTIONS */,
      ...
      "use agnostic conditions": {
        "value": "(Special) Agnostic Conditions Components are able to safely render on the client, guaranteeing that only their `ComponentForClient` will be effectively involved in Prime Client Logics Modules." /* $COMMENT#DIRECTIVE21#USE_CLIENT_LOGICS#USE_AGNOSTIC_CONDITIONS */,
      ...
      "kinds": {
        "value": "Prime Client Logics" /* $COMMENT#DIRECTIVE21#USE_CLIENT_LOGICS#KINDS */,
        "key": "DIRECTIVE21#USE_CLIENT_LOGICS#KINDS",
        "placeholder": "$COMMENT#DIRECTIVE21#USE_CLIENT_LOGICS#KINDS"
      },
      "kindsComma": {
        "value": "Prime Client Logics," /* $COMMENT#DIRECTIVE21#USE_CLIENT_LOGICS#KINDSCOMMA */,
        "key": "DIRECTIVE21#USE_CLIENT_LOGICS#KINDSCOMMA",
        "placeholder": "$COMMENT#DIRECTIVE21#USE_CLIENT_LOGICS#KINDSCOMMA"
      },
      "kindsPeriod": {
        "value": "Prime Client Logics." /* $COMMENT#DIRECTIVE21#USE_CLIENT_LOGICS#KINDSPERIOD */,
    ...
    "use agnostic logics": {
      ...
      "kinds": {
        "value": "Prime Agnostic Logics" /* $COMMENT#DIRECTIVE21#USE_AGNOSTIC_LOGICS#KINDS */,
        "key": "DIRECTIVE21#USE_AGNOSTIC_LOGICS#KINDS",
        "placeholder": "$COMMENT#DIRECTIVE21#USE_AGNOSTIC_LOGICS#KINDS"
      },
      "kindsComma": {
        "value": "Prime Agnostic Logics," /* $COMMENT#DIRECTIVE21#USE_AGNOSTIC_LOGICS#KINDSCOMMA */,
        "key": "DIRECTIVE21#USE_AGNOSTIC_LOGICS#KINDSCOMMA",
        "placeholder": "$COMMENT#DIRECTIVE21#USE_AGNOSTIC_LOGICS#KINDSCOMMA"
      },
      "kindsPeriod": {
        "value": "Prime Agnostic Logics." /* $COMMENT#DIRECTIVE21#USE_AGNOSTIC_LOGICS#KINDSPERIOD */,
    ...
    "use server components": {
      ...
      "use server components": {
        "value": "Lineal Server Components can compose with one another, now that thanks to the inclusion of Agnostic Components they are actual Server Components." /* $COMMENT#DIRECTIVE21#USE_SERVER_COMPONENTS#USE_SERVER_COMPONENTS */,
      ...
      "kinds": {
        "value": "Lineal Server Components" /* $COMMENT#DIRECTIVE21#USE_SERVER_COMPONENTS#KINDS */,
        "key": "DIRECTIVE21#USE_SERVER_COMPONENTS#KINDS",
        "placeholder": "$COMMENT#DIRECTIVE21#USE_SERVER_COMPONENTS#KINDS"
      },
      "kindsComma": {
        "value": "Lineal Server Components," /* $COMMENT#DIRECTIVE21#USE_SERVER_COMPONENTS#KINDSCOMMA */,
        "key": "DIRECTIVE21#USE_SERVER_COMPONENTS#KINDSCOMMA",
        "placeholder": "$COMMENT#DIRECTIVE21#USE_SERVER_COMPONENTS#KINDSCOMMA"
      },
      "kindsPeriod": {
        "value": "Lineal Server Components." /* $COMMENT#DIRECTIVE21#USE_SERVER_COMPONENTS#KINDSPERIOD */,
    ...
    "use client components": {
      ...
      "use server components": {
        "value": "Lineal Server Components cannot be the children of Lineal Client Components." /* $COMMENT#DIRECTIVE21#USE_CLIENT_COMPONENTS#USE_SERVER_COMPONENTS */,
      ...
      "module": {
        "value": "Lineal Client Components Module" /* $COMMENT#DIRECTIVE21#USE_CLIENT_COMPONENTS#MODULE */,
        "key": "DIRECTIVE21#USE_CLIENT_COMPONENTS#MODULE",
        "placeholder": "$COMMENT#DIRECTIVE21#USE_CLIENT_COMPONENTS#MODULE"
      },
      "modulePeriod": {
        "value": "Lineal Client Components Module." /* $COMMENT#DIRECTIVE21#USE_CLIENT_COMPONENTS#MODULEPERIOD */,
        "key": "DIRECTIVE21#USE_CLIENT_COMPONENTS#MODULEPERIOD",
        "placeholder": "$COMMENT#DIRECTIVE21#USE_CLIENT_COMPONENTS#MODULEPERIOD"
      },
      "kinds": {
        "value": "Lineal Client Components" /* $COMMENT#DIRECTIVE21#USE_CLIENT_COMPONENTS#KINDS */,
        "key": "DIRECTIVE21#USE_CLIENT_COMPONENTS#KINDS",
        "placeholder": "$COMMENT#DIRECTIVE21#USE_CLIENT_COMPONENTS#KINDS"
      },
      "kindsComma": {
        "value": "Lineal Client Components," /* $COMMENT#DIRECTIVE21#USE_CLIENT_COMPONENTS#KINDSCOMMA */,
        "key": "DIRECTIVE21#USE_CLIENT_COMPONENTS#KINDSCOMMA",
        "placeholder": "$COMMENT#DIRECTIVE21#USE_CLIENT_COMPONENTS#KINDSCOMMA"
      },
      "kindsPeriod": {
        "value": "Lineal Client Components." /* $COMMENT#DIRECTIVE21#USE_CLIENT_COMPONENTS#KINDSPERIOD */,
    ...
    "use agnostic components": {
      ...
      "use server functions": {
        "value": "(Special) Server Functions can be passed to Client Components as props when Client Components are also legally imported into Agnostic Components Modules." /* $COMMENT#DIRECTIVE21#USE_AGNOSTIC_COMPONENTS#USE_SERVER_FUNCTIONS */,
      ...
      "use agnostic conditions": {
        "value": "(Special) Agnostic Conditions Components can compose with Lineal Agnostic Components as if they were Lineal Agnostic Components themselves, making them a necessary mechanism for Lineal Server Components to be nested in any Agnostic Components." /* $COMMENT#DIRECTIVE21#USE_AGNOSTIC_COMPONENTS#USE_AGNOSTIC_CONDITIONS */,
      ...
      "kinds": {
        "value": "Lineal Agnostic Components" /* $COMMENT#DIRECTIVE21#USE_AGNOSTIC_COMPONENTS#KINDS */,
        "key": "DIRECTIVE21#USE_AGNOSTIC_COMPONENTS#KINDS",
        "placeholder": "$COMMENT#DIRECTIVE21#USE_AGNOSTIC_COMPONENTS#KINDS"
      },
      "kindsComma": {
        "value": "Lineal Agnostic Components," /* $COMMENT#DIRECTIVE21#USE_AGNOSTIC_COMPONENTS#KINDSCOMMA */,
        "key": "DIRECTIVE21#USE_AGNOSTIC_COMPONENTS#KINDSCOMMA",
        "placeholder": "$COMMENT#DIRECTIVE21#USE_AGNOSTIC_COMPONENTS#KINDSCOMMA"
      },
      "kindsPeriod": {
        "value": "Lineal Agnostic Components." /* $COMMENT#DIRECTIVE21#USE_AGNOSTIC_COMPONENTS#KINDSPERIOD */,
    ...
    "use client contexts": {
      ...
      "use server components": {
        "value": "Lineal Server Components may only pass through (Special) Client Contexts Components via the children prop within Server Components Modules." /* $COMMENT#DIRECTIVE21#USE_CLIENT_CONTEXTS#USE_SERVER_COMPONENTS */,
      ...
      "use client components": {
        "value": "Lineal Client Components can create client boundaries within (Special) Client Contexts Components." /* $COMMENT#DIRECTIVE21#USE_CLIENT_CONTEXTS#USE_CLIENT_COMPONENTS */,
    ...
    "use agnostic conditions": {
      ...
      "use agnostic logics": {
        "value": "Prime Agnostic Logics, being environment-agnostic logic, can safely support any Agnostic Components, including (Special) Agnostic Conditions Components. (In this case this is necessary for the import of the `conditionAgnosticComponent` function needed to make Agnostic Conditions Components.)" /* $COMMENT#DIRECTIVE21#USE_AGNOSTIC_CONDITIONS#USE_AGNOSTIC_LOGICS */,
      ...
      "use server components": {
        "value": "Lineal Server Components are to be paired as `ComponentForServer` components with `ComponentForClient` components to form (Special) Agnostic Conditions Components." /* $COMMENT#DIRECTIVE21#USE_AGNOSTIC_CONDITIONS#USE_SERVER_COMPONENTS */,
      ...
      "use client components": {
        "value": "Lineal Client Components are to be paired as `ComponentForClient` components with `ComponentForServer` components to form (Special) Agnostic Conditions Components." /* $COMMENT#DIRECTIVE21#USE_AGNOSTIC_CONDITIONS#USE_CLIENT_COMPONENTS */,
      ...
      "use agnostic components": {
        "value": "Lineal Agnostic Components can take the place of `ComponentForServer` and/or `ComponentForClient` components to form (Special) Agnostic Conditions Components." /* $COMMENT#DIRECTIVE21#USE_AGNOSTIC_CONDITIONS#USE_AGNOSTIC_COMPONENTS */,
      ...
      "use client contexts": {
        "value": "(Special) Client Contexts Components cannot be used as component arguments for (Special) Agnostic Conditions Components since they only take Lineal Components as arguments in their making." /* $COMMENT#DIRECTIVE21#USE_AGNOSTIC_CONDITIONS#USE_CLIENT_CONTEXTS */,
      ...
      "use agnostic conditions": {
        "value": "(Special) Agnostic Conditions Components, despite not being Lineal Components themselves, output components that can only be Lineal and compatible with their attributed rendering environments, making them acceptable arguments in the making of Agnostic Conditions Components." /* $COMMENT#DIRECTIVE21#USE_AGNOSTIC_CONDITIONS#USE_AGNOSTIC_CONDITIONS */,
      ...
      "kinds": {
        "value": "Special Agnostic Conditions" /* $COMMENT#DIRECTIVE21#USE_AGNOSTIC_CONDITIONS#KINDS */,
        "key": "DIRECTIVE21#USE_AGNOSTIC_CONDITIONS#KINDS",
        "placeholder": "$COMMENT#DIRECTIVE21#USE_AGNOSTIC_CONDITIONS#KINDS"
      },
      "kindsComma": {
        "value": "Special Agnostic Conditions," /* $COMMENT#DIRECTIVE21#USE_AGNOSTIC_CONDITIONS#KINDSCOMMA */,
        "key": "DIRECTIVE21#USE_AGNOSTIC_CONDITIONS#KINDSCOMMA",
        "placeholder": "$COMMENT#DIRECTIVE21#USE_AGNOSTIC_CONDITIONS#KINDSCOMMA"
      },
      "kindsPeriod": {
        "value": "Special Agnostic Conditions." /* $COMMENT#DIRECTIVE21#USE_AGNOSTIC_CONDITIONS#KINDSPERIOD */,
        "key": "DIRECTIVE21#USE_AGNOSTIC_CONDITIONS#KINDSPERIOD",
        "placeholder": "$COMMENT#DIRECTIVE21#USE_AGNOSTIC_CONDITIONS#KINDSPERIOD"
      },
      "specials": {
        "value": "(Special) Agnostic Conditions Components" /* $COMMENT#DIRECTIVE21#USE_AGNOSTIC_CONDITIONS#SPECIALS */,
        "key": "DIRECTIVE21#USE_AGNOSTIC_CONDITIONS#SPECIALS",
        "placeholder": "$COMMENT#DIRECTIVE21#USE_AGNOSTIC_CONDITIONS#SPECIALS"
      },
      "specialsComma": {
        "value": "(Special) Agnostic Conditions Components," /* $COMMENT#DIRECTIVE21#USE_AGNOSTIC_CONDITIONS#SPECIALSCOMMA */,
      ...
      "specialsPeriod": {
        "value": "(Special) Agnostic Conditions Components." /* $COMMENT#DIRECTIVE21#USE_AGNOSTIC_CONDITIONS#SPECIALSPERIOD */,
    ...
    "use agnostic strategies": {
      ...
      "specialsPeriod": {
        "value": "(Special) Agnostic Strategies." /* $COMMENT#DIRECTIVE21#USE_AGNOSTIC_STRATEGIES#SPECIALSPERIOD */,
    ...
    "forAliasVariables": {
      "serverNeverClient": {
        "value": "Prime Server Logics should never leak to the client.",
        "key": "DIRECTIVE21#FORALIASVARIABLES#SERVERNEVERCLIENT" /* $COMMENT#DIRECTIVE21#FORALIASVARIABLES#SERVERNEVERCLIENT */,
        "placeholder": "$COMMENT#DIRECTIVE21#FORALIASVARIABLES#SERVERNEVERCLIENT"
      },
      "clientNeverServer": {
        "value": "Prime Client Logics should never leak to the server.",
        "key": "DIRECTIVE21#FORALIASVARIABLES#CLIENTNEVERSERVER" /* $COMMENT#DIRECTIVE21#FORALIASVARIABLES#CLIENTNEVERSERVER */,
        "placeholder": "$COMMENT#DIRECTIVE21#FORALIASVARIABLES#CLIENTNEVERSERVER"
      },
      "agnosticCanServerClient": {
        "value": "Prime Agnostic Logics can run safely on the server just like they can on the client.",
        "key": "DIRECTIVE21#FORALIASVARIABLES#AGNOSTICCANSERVERCLIENT" /* $COMMENT#DIRECTIVE21#FORALIASVARIABLES#AGNOSTICCANSERVERCLIENT */,
        "placeholder": "$COMMENT#DIRECTIVE21#FORALIASVARIABLES#AGNOSTICCANSERVERCLIENT"
      },
      "agnosticCanClientServer": {
        "value": "Prime Agnostic Logics can run safely on the client just like they can on the server.",
        "key": "DIRECTIVE21#FORALIASVARIABLES#AGNOSTICCANCLIENTSERVER" /* $COMMENT#DIRECTIVE21#FORALIASVARIABLES#AGNOSTICCANCLIENTSERVER */,
        "placeholder": "$COMMENT#DIRECTIVE21#FORALIASVARIABLES#AGNOSTICCANCLIENTSERVER"
      },
      "serverFunctionsNoComponents": {
        "value": "(Special) Server Functions have no business working with React Components." /* $COMMENT#DIRECTIVE21#FORALIASVARIABLES#SERVERFUNCTIONSNOCOMPONENTS */,
      ...
      "serverLogicsCantBoth": {
        "value": "Prime Server Logics cannot run on both the server and the client.",
        "key": "DIRECTIVE21#FORALIASVARIABLES#SERVERLOGICSCANTBOTH" /* $COMMENT#DIRECTIVE21#FORALIASVARIABLES#SERVERLOGICSCANTBOTH */,
        "placeholder": "$COMMENT#DIRECTIVE21#FORALIASVARIABLES#SERVERLOGICSCANTBOTH"
      },
      "clientLogicsCantBoth": {
        "value": "Prime Client Logics cannot run on both the server and the client.",
        "key": "DIRECTIVE21#FORALIASVARIABLES#CLIENTLOGICSCANTBOTH" /* $COMMENT#DIRECTIVE21#FORALIASVARIABLES#CLIENTLOGICSCANTBOTH */,
        "placeholder": "$COMMENT#DIRECTIVE21#FORALIASVARIABLES#CLIENTLOGICSCANTBOTH"
      },
      "agnosticComponentsCanAny": {
        "value": "Lineal Agnostic Components can be composed with any Prime Environment Logics agnostically, as long as the Prime Environment Logics Module, by convention, does not export React components.",
        "key": "DIRECTIVE21#FORALIASVARIABLES#AGNOSTICCOMPONENTSCANANY" /* $COMMENT#DIRECTIVE21#FORALIASVARIABLES#AGNOSTICCOMPONENTSCANANY */,
        "placeholder": "$COMMENT#DIRECTIVE21#FORALIASVARIABLES#AGNOSTICCOMPONENTSCANANY"
      },
      "agnosticComponentsRenderAny": {
        "value": "Lineal Agnostic Components can render safely on the client just like they can on the server.",
        "key": "DIRECTIVE21#FORALIASVARIABLES#AGNOSTICCOMPONENTSRENDERANY" /* $COMMENT#DIRECTIVE21#FORALIASVARIABLES#AGNOSTICCOMPONENTSRENDERANY */,
        "placeholder": "$COMMENT#DIRECTIVE21#FORALIASVARIABLES#AGNOSTICCOMPONENTSRENDERANY"
      },
      "serverFunctionsClient": {
        "value": "(Special) Server Functions can be specifically triggered by Client Components.",
        "key": "DIRECTIVE21#FORALIASVARIABLES#SERVERFUNCTIONSCLIENT" /* $COMMENT#DIRECTIVE21#FORALIASVARIABLES#SERVERFUNCTIONSCLIENT */,
    ...
    "forComposedVariables": {
      ...
      "serverComponentsOKLogics": {
        "value": "Lineal Server Components are OK to be composed with Prime Server Logics as long as the Prime Server Logics Module," /* $COMMENT#DIRECTIVE21#FORCOMPOSEDVARIABLES#SERVERCOMPONENTSOKLOGICS */,
      ...
      "likeAnyClientComponentsComma": {
        "value": "like any Client Components," /* $COMMENT#DIRECTIVE21#FORCOMPOSEDVARIABLES#LIKEANYCLIENTCOMPONENTSCOMMA */,
      ...
      "likeAnyClientComponentsPeriod": {
        "value": "like any Client Components." /* $COMMENT#DIRECTIVE21#FORCOMPOSEDVARIABLES#LIKEANYCLIENTCOMPONENTSPERIOD */,
      ...
      "anyAgnosticComponentsPeriod": {
        "value": "any Agnostic Components." /* $COMMENT#DIRECTIVE21#FORCOMPOSEDVARIABLES#ANYAGNOSTICCOMPONENTSPERIOD */,
      ...
      "okClientLogics": {
        "value": "are OK to be composed with Prime Client Logics as long as the Prime Client Logics Module," /* $COMMENT#DIRECTIVE21#FORCOMPOSEDVARIABLES#OKCLIENTLOGICS */,
        "key": "DIRECTIVE21#FORCOMPOSEDVARIABLES#OKCLIENTLOGICS",
        "placeholder": "$COMMENT#DIRECTIVE21#FORCOMPOSEDVARIABLES#OKCLIENTLOGICS"
      },
      "agnosticComponentsCanAny": {
        "value": "Lineal Agnostic Components can be composed with any Prime Environment Logics agnostically, as long as the Prime Environment Logics Module," /* $COMMENT#DIRECTIVE21#FORCOMPOSEDVARIABLES#AGNOSTICCOMPONENTSCANANY */,
      ...
      "asIfLinealAgnostic": {
        "value": "as if they were Lineal Agnostic Components themselves," /* $COMMENT#DIRECTIVE21#FORCOMPOSEDVARIABLES#ASIFLINEALAGNOSTIC */,
      ...
      "canAnyPrimeLogics": {
        "value": "can be composed with any Prime Environment Logics agnostically, as long as the Prime Environment Logics Module," /* $COMMENT#DIRECTIVE21#FORCOMPOSEDVARIABLES#CANANYPRIMELOGICS */,
      ...
      "toCreateBoundaries": {
        "value": "to create client boundaries" /* $COMMENT#DIRECTIVE21#FORCOMPOSEDVARIABLES#TOCREATEBOUNDARIES */,
      ...
      "towrapTree": {
        "value": "to wrap some of the tree with client state accessible through child Client Components, and to pass through Server Components" /* $COMMENT#DIRECTIVE21#FORCOMPOSEDVARIABLES#TOWRAPTREE */,
      ...
      "whenRootOnServer": {
        "value": "when the root of the application is planted on the server." /* $COMMENT#DIRECTIVE21#FORCOMPOSEDVARIABLES#WHENROOTONSERVER */,
      ...
      "canClientComponents": {
        "value": "can be specifically triggered by Client Components." /* $COMMENT#DIRECTIVE21#FORCOMPOSEDVARIABLES#CANCLIENTCOMPONENTS */,
      ...
      "renderServerLikeClient": {
        "value": "can render safely on the server just like they can on the client." /* $COMMENT#DIRECTIVE21#FORCOMPOSEDVARIABLES#RENDERSERVERLIKECLIENT */,
      ...
      "renderClientLikeServer": {
        "value": "can render safely on the client just like they can on the server." /* $COMMENT#DIRECTIVE21#FORCOMPOSEDVARIABLES#RENDERCLIENTLIKESERVER */,
