...
export const resolvedConfigData = {
  ...
  "directive21": {
    ...
    "use agnostic strategies": {
      "use server logics": {
        "value": "(Special) Agnostic Strategies Modules can import all known modules except Special Agnostic Modules, which are file generators and should not be imported directly.",
