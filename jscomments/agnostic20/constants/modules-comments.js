...
export const serverLogicsComments = Object.freeze({
  ...
  importingWithExtension:
    "$COMMENT#TESTS#FORCOMPOSEDVARIABLES#IMPORTINGA $COMMENT#AGNOSTIC20#USE_SERVER_LOGICS#MODULE $COMMENT#TESTS#FORCOMPOSEDVARIABLES#WITHEXTENSIONPARENTHESES",
  importingByAFolder:
    "$COMMENT#TESTS#FORCOMPOSEDVARIABLES#IMPORTINGA $COMMENT#AGNOSTIC20#USE_SERVER_LOGICS#MODULE $COMMENT#TESTS#FORCOMPOSEDVARIABLES#BYFOLDER",
});
...
export const serverComponentsComments = Object.freeze({
  ...
  importingWithExtension:
    "$COMMENT#TESTS#FORCOMPOSEDVARIABLES#IMPORTINGA $COMMENT#AGNOSTIC20#USE_SERVER_COMPONENTS#MODULE $COMMENT#TESTS#FORCOMPOSEDVARIABLES#WITHEXTENSIONPARENTHESES",
  importingByAFolder:
    "$COMMENT#TESTS#FORCOMPOSEDVARIABLES#IMPORTINGA $COMMENT#AGNOSTIC20#USE_SERVER_COMPONENTS#MODULE $COMMENT#TESTS#FORCOMPOSEDVARIABLES#BYFOLDER",
});
...
export const serverFunctionsComments = Object.freeze({
  ...
  importingWithExtension:
    "$COMMENT#TESTS#FORCOMPOSEDVARIABLES#IMPORTINGA $COMMENT#AGNOSTIC20#USE_SERVER_FUNCTIONS#MODULE $COMMENT#TESTS#FORCOMPOSEDVARIABLES#WITHEXTENSIONPARENTHESES",
  importingByAFolder:
    "$COMMENT#TESTS#FORCOMPOSEDVARIABLES#IMPORTINGA $COMMENT#AGNOSTIC20#USE_SERVER_FUNCTIONS#MODULE $COMMENT#TESTS#FORCOMPOSEDVARIABLES#BYFOLDER",
});
...
export const clientLogicsComments = Object.freeze({
  ...
  importingWithExtension:
    "$COMMENT#TESTS#FORCOMPOSEDVARIABLES#IMPORTINGA $COMMENT#AGNOSTIC20#USE_CLIENT_LOGICS#MODULE $COMMENT#TESTS#FORCOMPOSEDVARIABLES#WITHEXTENSIONPARENTHESES",
  importingByAFolder:
    "$COMMENT#TESTS#FORCOMPOSEDVARIABLES#IMPORTINGA $COMMENT#AGNOSTIC20#USE_CLIENT_LOGICS#MODULE $COMMENT#TESTS#FORCOMPOSEDVARIABLES#BYFOLDER",
});
...
export const clientComponentsComments = Object.freeze({
  ...
  importingWithExtension:
    "$COMMENT#TESTS#FORCOMPOSEDVARIABLES#IMPORTINGA $COMMENT#AGNOSTIC20#USE_CLIENT_COMPONENTS#MODULE $COMMENT#TESTS#FORCOMPOSEDVARIABLES#WITHEXTENSIONPARENTHESES",
  importingByAFolder:
    "$COMMENT#TESTS#FORCOMPOSEDVARIABLES#IMPORTINGA $COMMENT#AGNOSTIC20#USE_CLIENT_COMPONENTS#MODULE $COMMENT#TESTS#FORCOMPOSEDVARIABLES#BYFOLDER",
});
...
export const agnosticLogicsComments = Object.freeze({
  ...
  importingWithExtension:
    "$COMMENT#TESTS#FORCOMPOSEDVARIABLES#IMPORTINGAN $COMMENT#AGNOSTIC20#USE_AGNOSTIC_LOGICS#MODULE $COMMENT#TESTS#FORCOMPOSEDVARIABLES#WITHEXTENSIONPARENTHESES",
  importingByAFolder:
    "$COMMENT#TESTS#FORCOMPOSEDVARIABLES#IMPORTINGAN $COMMENT#AGNOSTIC20#USE_AGNOSTIC_LOGICS#MODULE $COMMENT#TESTS#FORCOMPOSEDVARIABLES#BYFOLDER",
});
...
export const agnosticComponentsComments = Object.freeze({
  ...
  importingWithExtension:
    "$COMMENT#TESTS#FORCOMPOSEDVARIABLES#IMPORTINGAN $COMMENT#AGNOSTIC20#USE_AGNOSTIC_COMPONENTS#MODULEPERIOD $COMMENT#TESTS#FORCOMPOSEDVARIABLES#WITHEXTENSIONPARENTHESES",
  importingByAFolder:
    "$COMMENT#TESTS#FORCOMPOSEDVARIABLES#IMPORTINGAN $COMMENT#AGNOSTIC20#USE_AGNOSTIC_COMPONENTS#MODULE $COMMENT#TESTS#FORCOMPOSEDVARIABLES#BYFOLDER",
});
