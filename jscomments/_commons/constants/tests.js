export const testsComments = Object.freeze({
  forComposedVariables: Object.freeze({
    ...
    viaAlias: "Via alias." /* $COMMENT#TESTS#FORCOMPOSEDVARIABLES#VIAALIAS */,
    viaBaseUrl:
      "Via baseUrl." /* $COMMENT#TESTS#FORCOMPOSEDVARIABLES#VIABASEURL */,
    valid: "Valid." /* $COMMENT#TESTS#FORCOMPOSEDVARIABLES#VALID */,
    invalid: "Invalid." /* $COMMENT#TESTS#FORCOMPOSEDVARIABLES#INVALID */,
  }),
});
