...
// $COMMENT#TESTS#VALID
// $COMMENT#DIRECTIVE21#USE_AGNOSTIC_CONDITIONS#SPECIALSCOMMA $COMMENT#DIRECTIVE21#FORCOMPOSEDVARIABLES#ASIFLINEALAGNOSTIC can render safely on the client just like they can on the server, in a mechanism that allows Client Contexts Components to safely and indirectly compose with child $COMMENT#AGNOSTIC20#USE_SERVER_COMPONENTS#KINDS within Client Contexts Modules.
