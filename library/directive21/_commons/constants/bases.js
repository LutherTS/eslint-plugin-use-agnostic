...
export const commentedDirectives_blockedImports = Object.freeze({
  [USE_SERVER_LOGICS]: Object.freeze([
    ...
    makeBlockedImport(
      USE_SERVER_LOGICS,
      USE_AGNOSTIC_STRATEGIES
    ) /* $COMMENT#DIRECTIVE21#USE_SERVER_LOGICS#USE_AGNOSTIC_STRATEGIES */,
  ]),
  [USE_CLIENT_LOGICS]: Object.freeze([
    ...
    makeBlockedImport(
      USE_CLIENT_LOGICS,
      USE_AGNOSTIC_STRATEGIES
    ) /* $COMMENT#DIRECTIVE21#USE_CLIENT_LOGICS#USE_AGNOSTIC_STRATEGIES */,
  ]),
  [USE_AGNOSTIC_LOGICS]: Object.freeze([
    ...
    makeBlockedImport(
      USE_AGNOSTIC_LOGICS,
      USE_AGNOSTIC_STRATEGIES
    ) /* $COMMENT#DIRECTIVE21#USE_AGNOSTIC_LOGICS#USE_AGNOSTIC_STRATEGIES */,
  ]),
  [USE_SERVER_COMPONENTS]: Object.freeze([
    ...
    makeBlockedImport(
      USE_SERVER_COMPONENTS,
      USE_AGNOSTIC_STRATEGIES
    ) /* $COMMENT#DIRECTIVE21#USE_SERVER_COMPONENTS#USE_AGNOSTIC_STRATEGIES */,
  ]),
  [USE_CLIENT_COMPONENTS]: Object.freeze([
    ...
    makeBlockedImport(
      USE_CLIENT_COMPONENTS,
      USE_AGNOSTIC_STRATEGIES
    ) /* $COMMENT#DIRECTIVE21#USE_CLIENT_COMPONENTS#USE_AGNOSTIC_STRATEGIES */,
  ]),
  [USE_AGNOSTIC_COMPONENTS]: Object.freeze([
    ...
    makeBlockedImport(
      USE_AGNOSTIC_COMPONENTS,
      USE_AGNOSTIC_STRATEGIES
    ) /* $COMMENT#DIRECTIVE21#USE_AGNOSTIC_COMPONENTS#USE_AGNOSTIC_STRATEGIES */,
  ]),
  [USE_SERVER_FUNCTIONS]: Object.freeze([
    ...
    makeBlockedImport(
      USE_SERVER_FUNCTIONS,
      USE_AGNOSTIC_STRATEGIES
    ) /* $COMMENT#DIRECTIVE21#USE_SERVER_FUNCTIONS#USE_AGNOSTIC_STRATEGIES */,
  ]),
  [USE_CLIENT_CONTEXTS]: Object.freeze([
    ...
    // USE_AGNOSTIC_CONDITIONS $COMMENT#DIRECTIVE21#USE_CLIENT_CONTEXTS#USE_AGNOSTIC_CONDITIONS
    makeBlockedImport(
      USE_CLIENT_CONTEXTS,
      USE_AGNOSTIC_STRATEGIES
    ) /* $COMMENT#DIRECTIVE21#USE_CLIENT_CONTEXTS#USE_AGNOSTIC_STRATEGIES */,
  ]),
  [USE_AGNOSTIC_CONDITIONS]: Object.freeze([
    ...
    makeBlockedImport(
      USE_AGNOSTIC_CONDITIONS,
      USE_AGNOSTIC_STRATEGIES
    ) /* $COMMENT#DIRECTIVE21#USE_AGNOSTIC_CONDITIONS#USE_AGNOSTIC_STRATEGIES */,
  ]),
  [USE_AGNOSTIC_STRATEGIES]: Object.freeze([
    ...
    makeBlockedImport(
      USE_AGNOSTIC_STRATEGIES,
      USE_AGNOSTIC_CONDITIONS
    ) /* $COMMENT#DIRECTIVE21#USE_AGNOSTIC_STRATEGIES#USE_AGNOSTIC_CONDITIONS */,
    makeBlockedImport(
      USE_AGNOSTIC_STRATEGIES,
      USE_AGNOSTIC_STRATEGIES
    ) /* $COMMENT#DIRECTIVE21#USE_AGNOSTIC_STRATEGIES#USE_AGNOSTIC_STRATEGIES */,
  ]),
});
