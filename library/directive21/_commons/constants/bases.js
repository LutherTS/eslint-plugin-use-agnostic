import {
  ...
  SERVER as COMMONS_SERVER,
  CLIENT as COMMONS_CLIENT,
  AGNOSTIC as COMMONS_AGNOSTIC,
 ...
 * @typedef {import('../../../../types/directive21/_commons/typedefs.js').StrategizedExtension} StrategizedExtension
 * @typedef {import('../../../../types/directive21/_commons/typedefs.js').StrategizedExtensions} StrategizedExtensions
 * @typedef {import('../../../../types/directive21/_commons/typedefs.js').ConditionedExtension} ConditionedExtension
 * @typedef {import('../../../../types/directive21/_commons/typedefs.js').ConditionedExtensions} ConditionedExtensions
 *
...
/** @type {StrategizedExtensions} */
export const strategizedExtensionsArray = Object.freeze([
  DOT_SERVER_LOGICS,
  DOT_CLIENT_LOGICS,
  DOT_AGNOSTIC_LOGICS,
...
/** @type {ReadonlySet<StrategizedExtension>} */
export const strategizedExtensionsSet = new Set(strategizedExtensionsArray);

// mapped commented directives to their strategized extensions
export const commentedDirectives_strategizedExtensions = Object.freeze({
  [USE_SERVER_LOGICS]: DOT_SERVER_LOGICS,
  [USE_CLIENT_LOGICS]: DOT_CLIENT_LOGICS,
  [USE_AGNOSTIC_LOGICS]: DOT_AGNOSTIC_LOGICS,
  [USE_SERVER_COMPONENTS]: DOT_SERVER_COMPONENTS,
  [USE_CLIENT_COMPONENTS]: DOT_CLIENT_COMPONENTS,
  [USE_AGNOSTIC_COMPONENTS]: DOT_AGNOSTIC_COMPONENTS,
  [USE_SERVER_FUNCTIONS]: DOT_SERVER_FUNCTIONS,
  [USE_CLIENT_CONTEXTS]: DOT_CLIENT_CONTEXTS,
});
...
export const commentedDirectives_blockedImports = Object.freeze({
  [USE_SERVER_LOGICS]: Object.freeze([
    ...
    // USE_AGNOSTIC_CONDITIONS $COMMENT#DIRECTIVE21#USE_SERVER_LOGICS#USE_AGNOSTIC_CONDITIONS
    makeBlockedImport(
      USE_SERVER_LOGICS,
      USE_AGNOSTIC_STRATEGIES,
  ...
  [USE_CLIENT_LOGICS]: Object.freeze([
    ...
    // USE_AGNOSTIC_CONDITIONS $COMMENT#DIRECTIVE21#USE_CLIENT_LOGICS#USE_AGNOSTIC_CONDITIONS
    makeBlockedImport(
      USE_CLIENT_LOGICS,
      USE_AGNOSTIC_STRATEGIES,
    ) /* $COMMENT#DIRECTIVE21#USE_AGNOSTIC_STRATEGIES#INVALID */,
...
export const SERVER = COMMONS_SERVER;
export const CLIENT = COMMONS_CLIENT;
export const AGNOSTIC = COMMONS_AGNOSTIC;
...
/** @type {ConditionedExtensions} */
export const conditionedExtensionsArray = Object.freeze([
  DOT_AGNOSTIC_SERVER,
  DOT_AGNOSTIC_CLIENT,
]);

// conditioned extensions set
/** @type {ReadonlySet<ConditionedExtension>} */
export const conditionedExtensionsSet = new Set(conditionedExtensionsArray);

// mapped environments to their conditioned extensions
export const environments_conditionedExtensions = Object.freeze({
  [SERVER]: DOT_AGNOSTIC_SERVER,
  [CLIENT]: DOT_AGNOSTIC_CLIENT,
});
